...
class PodcastFeedReaderTest {
    ...
    void example1(AbstractRssReader<PodcastChannel, PodcastItem> feedReader) {
        ...
        assertThat(liveItem.getPodcastAlternateEnclosures().size()).isEqualTo(1);
        ...
        assertThat(liveItem.getPodcastAlternateEnclosures().get(0).getSources().size()).isEqualTo(2);
        ...
        assertThat(liveItem.getEnclosures().size()).isEqualTo(1);
        ...
        assertThat(liveItem.getPodcastContentLinks().size()).isEqualTo(2);
        ...
        for (PodcastItem podcastItem : items) {
            ...
            assertThat(channel.getPodcastBlocks().size()).isEqualTo(3);
            ...
            assertThat(channel.getPodcastFundings().size()).isEqualTo(1);
            ...
            assertThat(channel.getPodcastLocations().size()).isEqualTo(1);
            ...
            assertThat(channel.getItunesCategories().size()).isEqualTo(2);
            ...
            assertThat(channel.getPodcastValues().size()).isEqualTo(1);
            ...
            assertThat(channel.getPodcastValues().get(0).getValueRecipients().size()).isEqualTo(2);
            ...
            assertThat(channel.getPodcastValues().get(0).getValueTimeSplits().size()).isEqualTo(2);
            ...
            assertThat(channel.getPodcastValues().get(0).getValueTimeSplits().get(1).getValueRecipients().size()).isEqualTo(2);
            ...
            assertThat(channel.getPodcastTrailers().size()).isEqualTo(1);
            ...
            assertThat(channel.getPodcastTxts().size()).isEqualTo(3);
            ...
            assertThat(channel.getPodcastImages().size()).isEqualTo(4);
        ...
        assertThat(item.getPodcastImages().size()).isEqualTo(4);
        ...
        assertThat(item.getPodcastSoundbites().size()).isEqualTo(1);
        ...
        assertThat(item.getPodcastTranscripts().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastPersons().size()).isEqualTo(3);
        ...
        assertThat(item.getPodcastAlternateEnclosures().size()).isEqualTo(5);
        ...
        assertThat(item.getPodcastAlternateEnclosures().get(0).getSources().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastAlternateEnclosures().get(4).getSources().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastValues().size()).isEqualTo(1);
        ...
        assertThat(item.getPodcastValues().get(0).getValueRecipients().size()).isEqualTo(3);
        ...
        assertThat(item.getPodcastValues().get(0).getValueTimeSplits().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastValues().get(0).getValueTimeSplits().get(1).getValueRecipients().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastSocialInteracts().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastTxts().size()).isEqualTo(4);
    ...
    void example2(AbstractRssReader<PodcastChannel, PodcastItem> feedReader) {
        ...
        assertThat(channel.getPodcastValues().get(0).getValueRecipients().size()).isEqualTo(3);
        ...
        assertThat(channel.getPodcastPersons().size()).isEqualTo(1);
        ...
        assertThat(channel.getPodcastPodrolls().size()).isEqualTo(3);
        ...
        assertThat(channel.getPodcastImages().size()).isEqualTo(2);
        ...
        assertThat(item.getPodcastImages().size()).isEqualTo(1);
