...
public class PodcastExtensions {
    ...
    private static void onChannelTag(FeedExtensionRegistry<? extends PodcastChannel, ? extends PodcastItem> registry, DateTimeParser dateTimeParser) {
        ...
        registry.addOnChannelTag("/rss/channel/podcast:value/podcast:valueRecipient", channel -> getLast(channel.getPodcastValues()).addValueRecipient(new PodcastValueRecipient()));
        ...
        registry.addOnChannelTag("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", channel -> getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).addValueRecipient(new PodcastValueRecipient()));
    ...
    private static void channelAttributeExtensions(FeedExtensionRegistry<? extends PodcastChannel, ? extends PodcastItem> registry) {
        ...
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "name", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setName(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "type", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setType(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "address", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setAddress(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "customKey", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomKey(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "customValue", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomValue(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "split", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> mapInteger(value, valueRecipient::setSplit)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueRecipient", "fee", (channel, value) -> Optional.ofNullable(getLast(getLast(channel.getPodcastValues()).getValueRecipients())).ifPresent(valueRecipient -> mapBoolean(value, valueRecipient::setFee)));
        ...
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "name", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setName(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "type", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setType(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "address", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setAddress(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "customKey", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomKey(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "customValue", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomValue(value)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "split", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> mapInteger(value, valueRecipient::setSplit)));
        registry.addChannelExtension("/rss/channel/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "fee", (channel, value) -> Optional.ofNullable(getLast(getLast(getLast(channel.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> mapBoolean(value, valueRecipient::setFee)));
    ...
    private static void onItemTag(FeedExtensionRegistry<? extends PodcastChannel, ? extends PodcastItem> registry) {
        ...
        registry.addOnItemTag("/rss/channel/item/podcast:value/podcast:valueRecipient", item -> getLast(item.getPodcastValues()).addValueRecipient(new PodcastValueRecipient()));
        ...
        registry.addOnItemTag("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", item -> getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).addValueRecipient(new PodcastValueRecipient()));
    ...
    private static void itemAttributesExtensions(FeedExtensionRegistry<? extends PodcastChannel, ? extends PodcastItem> registry) {
        ...
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "name", (item, value) -> getLast(getLast(item.getPodcastValues()).getValueRecipients()).setName(value));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "type", (item, value) -> getLast(getLast(item.getPodcastValues()).getValueRecipients()).setType(value));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "address", (item, value) -> getLast(getLast(item.getPodcastValues()).getValueRecipients()).setAddress(value));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "customKey", (item, value) -> getLast(getLast(item.getPodcastValues()).getValueRecipients()).setCustomKey(value));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "customValue", (item, value) -> getLast(getLast(item.getPodcastValues()).getValueRecipients()).setCustomValue(value));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "split", (item, value) -> Optional.of(getLast(getLast(item.getPodcastValues()).getValueRecipients())).ifPresent(recipient -> mapInteger(value, recipient::setSplit)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueRecipient", "fee", (item, value) -> Optional.of(getLast(getLast(item.getPodcastValues()).getValueRecipients())).ifPresent(recipient -> mapBoolean(value, recipient::setFee)));
        ...
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "name", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setName(value)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "type", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setType(value)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "address", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setAddress(value)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "customKey", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomKey(value)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "customValue", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> valueRecipient.setCustomValue(value)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "split", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> mapInteger(value, valueRecipient::setSplit)));
        registry.addItemExtension("/rss/channel/item/podcast:value/podcast:valueTimeSplit/podcast:valueRecipient", "fee", (item, value) -> Optional.ofNullable(getLast(getLast(getLast(item.getPodcastValues()).getValueTimeSplits()).getValueRecipients())).ifPresent(valueRecipient -> mapBoolean(value, valueRecipient::setFee)));
